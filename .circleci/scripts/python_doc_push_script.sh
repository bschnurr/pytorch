...
curl -X PATCH -H "Accept: application/vnd.github+json" -H "Authorization: Bearer ${GITHUB_TOKEN}" https://api.github.com/repos/pytorch/pytorch.github.io/pull/1155 -d '{"state":"open"}'
